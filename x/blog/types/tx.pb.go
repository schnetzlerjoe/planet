...
func init() {
	proto.RegisterType((*MsgSendIbcPost)(nil), "schnetzlerjoe.planet.blog.MsgSendIbcPost")
	proto.RegisterType((*MsgSendIbcPostResponse)(nil), "schnetzlerjoe.planet.blog.MsgSendIbcPostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	,
}
...
func (c *msgClient) SendIbcPost(ctx context.Context, in *MsgSendIbcPost, opts ...grpc.CallOption) (*MsgSendIbcPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/schnetzlerjoe.planet.blog.Msg/SendIbcPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SendIbcPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/schnetzlerjoe.planet.blog.Msg/SendIbcPost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "schnetzlerjoe.planet.blog.Msg",
